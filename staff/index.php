...
if (!isset($_SESSION['user_role_name']) || $_SESSION['user_role_name'] !== 'staff') {
...
<div class="relative min-h-screen lg:flex">
    <?php
    // Include the staff-specific sidebar
    ...
    <div class="flex-1 flex flex-col relative z-0">
        ...
        <main class="flex-1 bg-gray-100 p-6">
            ...
            <p class="mt-2 text-gray-600">This is your dashboard. Staff-specific features will be added here.</p>
        </main>
    </div>
</div>
