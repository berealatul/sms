<?php
$pageTitle = "Login";
// No header include here yet, we need to handle session start first.
...
<body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <h2 class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Student Monitoring System</h2>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <form class="space-y-6" action="process_auth.php" method="POST">
                <div>
            ...
            <p class="mt-10 text-center text-xs text-gray-400">
                &copy; <?php echo date("Y"); ?> Student Monitoring System. All rights reserved.
            </p>
        </div>
    </div>
</body>
