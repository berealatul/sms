<?php
require_once __DIR__ . '/../includes/header.php'; // Includes session start and DB connection
...
if (!isset($_SESSION['user_role_name']) || $_SESSION['user_role_name'] !== 'admin') {
    ...
    header('Location: /programme/programmes.php');
    exit();
}
...
try {
    ...
    // Catch any exceptions (including DB unique constraint violations)
    $_SESSION['error_message'] = $e->getMessage();
}

// Redirect back to the programmes page
header('Location: /programme/programmesphp');
exit();
