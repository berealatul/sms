...
// Fetch all programmes with their degree level names (Corrected Query)
...
<div class="relative min-h-screen lg:flex">
    ...
    <div id="sidebar" class="bg-white w-64 absolute inset-y-0 left-0 transform -translate-x-full lg:relative lg:translate-x-0 transition-transform duration-200 ease-in-out z-30 shadow-md">
        ...
        <nav class="mt-4">
            <a href="/../admin.php" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-200">
                <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7" />
                </svg>
                Dashboard
            </a>
            <a href="/programmes.php" class="flex items-center px-4 py-3 text-gray-700 bg-gray-200 font-bold">
                <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex-1 flex flex-col relative z-0">
        ...
        <main class="flex-1 bg-gray-100 p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-semibold text-gray-800">Manage Programmes</h2>
                            ...
                            <?php while ($programme = $programmes_result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="/process_programme.php?action=toggle_status&id=<?php echo $programme['id']; ?>" class="ml-4 text-gray-600 hover:text-gray-900" onclick="return confirm('Are you sure you want to toggle the status of this programme?');">
...
<div id="add-modal" class="fixed z-50 inset-0 overflow-y-auto hidden">
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form action="/process_programme.php" method="POST">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                // Populate the edit form with data attributes from the button
